    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="{{ route('dashboard') }}" class="text-gray-400">
                        ...
                        Class<span class="font-bold text-white">Connect</span>
                    </a>
                </div>
            </div>
            ...
            <div class="hidden sm:flex sm:items-center sm:ml-6">
                ...
                @else
                    <x-primary-button type="button" onclick="document.querySelector('#linkLogin').click()">
                        Sign In
                    </x-primary-button>
                    <a href="{{ route('login') }}" id="linkLogin" class="hidden"></a>
                @endif
            </div>
